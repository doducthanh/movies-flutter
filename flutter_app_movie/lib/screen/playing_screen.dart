                                    ...
                                    children: <Widget>[
                                      Slider(
                                        ...
                                        onChanged: (newValue){
                                          ...
                                          _behaviorSubject.sink.add(Duration(seconds: newValue.toInt()));
                                        },
                                      ),
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            Text(AppUtility.formatDurationSring(snapshot.data), style: TextStyle(color: Colors.white),),
                                            Text(AppUtility.formatDurationSring(_controller.value.duration), style: TextStyle(color: Colors.white),)
                                          ],
                                        ),
                                      )
                                    ],
